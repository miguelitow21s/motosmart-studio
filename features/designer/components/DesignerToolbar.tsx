...
import { MousePointer2, Pencil, Type, Trash2, Undo2, Redo2, Download, Save, Loader2 } from "lucide-react"
...
const TOOLS: { id: DesignerTool; icon: React.ElementType; label: string; shortcut: string }[] = [
  ...
  { id: "draw", icon: Pencil, label: "Dibujar", shortcut: "D" },
  { id: "text", icon: Type, label: "Texto", shortcut: "T" },
]

const STROKE_WIDTHS = [2, 4, 6, 10]

export function DesignerToolbar({ onSave, onExportPng, onDeleteSelected }: Props) {
  const {
    tool, setTool,
  ...
  return (
    <TooltipProvider delayDuration={400}>
      <div className="flex flex-wrap items-center gap-2 px-4 py-2 bg-[#111113] border-b border-zinc-800/60">
        {/* Tools */}
