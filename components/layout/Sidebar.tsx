  ...
  return (
    <TooltipProvider delayDuration={0}>
      <motion.aside
        ...
        className="relative flex flex-col h-full bg-[#111113] border-r border-zinc-800/60 shrink-0 overflow-hidden"
      >
        {/* Logo */}
          ...
          <div className="flex items-center gap-3 min-w-0">
            ...
            <AnimatePresence>
              {sidebarOpen && (
                ...
                >
                  <span className="font-bold text-sm text-zinc-100 whitespace-nowrap tracking-tight">
                    MotoSmart
                  </span>
                  <span className="ml-1 text-xs font-medium text-indigo-400 whitespace-nowrap">
                    Studio
                  </span>
                </motion.div>
              )}
